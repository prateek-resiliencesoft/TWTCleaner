...
<link rel="stylesheet" href="Admin/css/jquery.alerts.css" media="screen"/>
<script src="Admin/js/jquery-1.7.2.min.js"></script>
<script src="Admin/js/jquery.alerts.js"></script>
<script type="text/javascript">
    ...
    $("document").ready(function(){
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "RtcleanerDetails.php", //Relative or absolute path to response.php file
            data: data,
            success: function(data, status) {
                ...
                for (var i=0;i<data.length;i++) {
                    ...
                    innerTableHtml += "<tr>";
                    innerTableHtml += "<td class='center'>"+data[i].id+"</td>";
