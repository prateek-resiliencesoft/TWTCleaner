...
<script type="text/javascript">
    $("document").ready(function(){
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "../classes/DeleteRtDetails.php", //Relative or absolute path to response.php file
            data: data,
            success: function(data, status) {
                ...
                for (var i=0;i<data.length;i++) {
                    ...
                    innerTableHtml += "<td class='center'>"+data[i].CursorValue+"</td>";
                    innerTableHtml += "<td class='center'>"+data[i].DeletedRT+"</td>";
